...
def monster_access(key):
	monsters = {
		...
		"chaos_daughter": enemy_round.generate_actor(*[2900, 300, 800, 6500, 10, random.randrange(18, 29), "human", "female", "the daughter of chaos"]),
...
def ally_access(key):
	allies = {
		"homeboy": enemy_round.generate_actor(*[15 * ability.ability['level'], 4, 7, 70, 10, 1, "human", "male", "your homeboy"]),
		"tamara": enemy_round.generate_actor(*[15 * ability.ability['level'], 4, 7, 70, 10, 1, "human", "female", "Tamara"]),
	}
	return allies[key]
