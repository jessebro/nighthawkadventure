...
xp_handouts = {
	...
	"small": enemy_round.generate_enemy(*[0, 0, 0, 0, 0, 25, " ", " ", " "]),
	"medium": enemy_round.generate_enemy(*[0, 0, 0, 0, 0, 50, " ", " ", " "]),
	"large": enemy_round.generate_enemy(*[0, 0, 0, 0, 0, 85, " ", " ", " "])
}
...
def monster_access(key):
	monsters = {
		...
		"chaos_daughter": enemy_round.generate_enemy(*[18, 3, 8, 65, 10, random.randrange(18, 29), "human", "female", "the daughter of chaos"]),
		"ghoul": enemy_round.generate_enemy(*[9, 3, 5, 45, 10, random.randrange(5, 11), "monster", "it", "the ghoul"]),
		"bone_hag": enemy_round.generate_enemy(*[22, 4, 7, 45, 0, random.randrange(15, 24), "monster", "it", "the bone hag"]),
		...
		"moracka": enemy_round.generate_enemy(*[25, 4, 8, 50, 13, random.randrange(20, 30), "monster", "it", "the moracka"]),
		"ogre": enemy_round.generate_enemy(*[30, 5, 12, 20, -10, random.randrange(19, 27), "monster", "it", "the ogre"]),
		"injured ogre": enemy_round.generate_enemy(*[23, 5, 12, 20, -10, random.randrange(19, 27), "monster", "it", "the ogre"]),
		"wolf": enemy_round.generate_enemy(*[7, 3, 8, 65, 10, random.randrange(4, 10), "monster", "it", "the wolf"]),
	}
	return monsters[key]
